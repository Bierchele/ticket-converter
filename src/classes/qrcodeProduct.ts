...
export class QRProduct implements Image {
  ...
  constructor(textRowObj: TextRow) {
    ...
    this.width = textRowObj.width / 1.3895582329317269;
    this.height = textRowObj.width / 1.3895582329317269;
    this.fill = "#000000";
    this.stroke = null;
    this.strokeWidth = 1;
    ...
    this.scaleX = textRowObj.width / 249; //* 0.8554913294797688 / 249);
    this.scaleY = textRowObj.height / 249; // * 0.8554913294797688 / 249);
    this.angle = 0;
    this.flipX = false;
    this.flipY = false;
    this.opacity = 1;
